...
const heritageSites = [
  ...
  // NEW KOSOVO SITES - Architectural / Urban / Museum
  {
    id: 131,
    name: "Hydroelectric Power Plant Museum",
    alternateName: "Muzeu i Hidrocentralit",
    type: "Museum",
    region: "Kosovo",
    county: "Prizren",
    lat: 42.2150,
    ...
    endYear: 2025,
    era: ["Modern"],
    description: "Historic hydroelectric power plant built in 1926-1928, now converted into a museum showcasing industrial heritage and the history of electricity in Kosovo.",
    highlights: ["Industrial Heritage", "Historic Machinery", "Early 20th Century Engineering", "Museum Exhibits"],
    visitInfo: { hours: "9:00 AM - 5:00 PM", entry: "2 EUR", duration: "1 hour" },
    image: "/images/ruins.jpg",
    rating: 4.0,
    reviews: 89,
    verified: true
  },
  {
    id: 132,
    name: "Kino Lumbardhi",
    alternateName: "Cinema Lumbardhi",
    type: "Cultural",
    region: "Kosovo",
    county: "Prizren",
    lat: 42.2140,
    ...
    endYear: 2025,
    era: ["Modern"],
    description: "Iconic open-air cinema and cultural center in Prizren. A beloved gathering place for film screenings, concerts, and cultural events.",
    highlights: ["Open-Air Cinema", "Cultural Events", "Historic Venue", "Riverside Location"],
    visitInfo: { hours: "Evening events", entry: "Varies", duration: "2-3 hours" },
    image: "/images/ruins.jpg",
    rating: 4.6,
    reviews: 567,
    verified: true
  ...
  {
    id: 133,
    name: "Namazgjah Mosque",
    alternateName: "Kerek Mosque / Xhamia e Namazgjasë",
    type: "Religious",
    region: "Kosovo",
    county: "Prizren",
    lat: 42.2120,
    ...
    endYear: 2025,
    era: ["Ottoman"],
    description: "15th century Ottoman mosque, one of the oldest in Prizren. Features classic Ottoman architecture and serves as an important religious site.",
    highlights: ["15th Century Mosque", "Ottoman Architecture", "Historic Prayer Hall", "Islamic Heritage"],
    visitInfo: { hours: "Open for prayers", entry: "Free", duration: "30 minutes" },
    image: "/images/mosque.jpg",
    rating: 4.3,
    reviews: 156,
    verified: true
  ...
  {
    id: 134,
    name: "Hadro Family Residential Complex",
    alternateName: "Kompleksi i Familjes Hadro",
    type: "Historic House",
    region: "Kosovo",
    county: "Prizren",
    lat: 42.2130,
    ...
    endYear: 2025,
    era: ["Ottoman"],
    description: "19th century historic residential complex showcasing traditional Prizren urban architecture. An important example of Ottoman-era domestic life.",
    highlights: ["19th Century Architecture", "Traditional Urban House", "Historic Ensemble", "Ottoman Heritage"],
    visitInfo: { hours: "By appointment", entry: "Free", duration: "45 minutes" },
    image: "/images/castle.jpg",
    rating: 3.9,
    reviews: 67,
    verified: true
  ...
  {
    id: 135,
    name: "Tahir Bey Konak",
    alternateName: "Konaku i Tahir Beut",
    type: "Historic House",
    region: "Kosovo",
    county: "Pejë",
    lat: 42.6600,
    ...
    endYear: 2025,
    era: ["Ottoman"],
    description: "Historic 19th century Ottoman-era mansion in Peja. Represents the architectural style of wealthy families during the Ottoman period.",
    highlights: ["Ottoman Mansion", "19th Century Architecture", "Historic Interiors", "Cultural Heritage"],
    visitInfo: { hours: "10:00 AM - 4:00 PM", entry: "2 EUR", duration: "45 minutes" },
    image: "/images/castle.jpg",
    rating: 4.0,
    reviews: 78,
    verified: true
  ...
  {
    id: 136,
    name: "Kasapolli Konak",
    alternateName: "Konaku i Kasapollit",
    type: "Historic House",
    region: "Kosovo",
    county: "Pejë",
    lat: 42.6590,
    ...
    endYear: 2025,
    era: ["Ottoman"],
    description: "Well-preserved 19th century Ottoman mansion in Peja. Features traditional architectural elements and historic significance.",
    highlights: ["Ottoman Architecture", "Historic Mansion", "Traditional Design", "Cultural Landmark"],
    visitInfo: { hours: "By appointment", entry: "Free", duration: "30 minutes" },
    image: "/images/castle.jpg",
    rating: 3.8,
    reviews: 45,
    verified: true
  ...
  {
    id: 137,
    name: "Haxhi Zeka Tower",
    alternateName: "Kulla e Haxhi Zekës",
    type: "Tower",
    region: "Kosovo",
    county: "Pejë",
    lat: 42.6610,
    ...
    endYear: 2025,
    era: ["Ottoman"],
    description: "Traditional Albanian tower house (kulla) of Haxhi Zeka, an important figure in Albanian history. Represents defensive residential architecture.",
    highlights: ["Traditional Kulla", "Albanian Heritage", "Defensive Architecture", "Historic Figure"],
    visitInfo: { hours: "9:00 AM - 5:00 PM", entry: "1 EUR", duration: "1 hour" },
    image: "/images/castle.jpg",
    rating: 4.2,
    reviews: 123,
  ...
  {
    id: 138,
    name: "Former Academy of Sciences Building",
    alternateName: "Ndërtesa e Akademisë së Shkencave",
    ...
    endYear: 2025,
    era: ["Ottoman", "Modern"],
    description: "19th century historic building in central Prishtina. Once housed the Academy of Sciences and represents important civic architecture.",
    highlights: ["19th Century Building", "Historic Architecture", "Civic Heritage", "Urban Landmark"],
    visitInfo: { hours: "Exterior viewing", entry: "Free", duration: "15 minutes" },
    image: "/images/castle.jpg",
    rating: 3.7,
    reviews: 56,
  ...
  {
    id: 139,
    name: "IKMM Residential House",
    alternateName: "Shtëpia e IKMM-së",
    type: "Historic House",
    region: "Kosovo",
    county: "Prishtina",
    lat: 42.6610,
    ...
    endYear: 2025,
    era: ["Ottoman"],
    description: "19th century historic residential house in Prishtina. An example of traditional urban architecture from the Ottoman period.",
    highlights: ["Ottoman Era House", "Urban Architecture", "Historic Preservation", "Cultural Heritage"],
    visitInfo: { hours: "By appointment", entry: "Free", duration: "30 minutes" },
    image: "/images/castle.jpg",
    rating: 3.6,
    reviews: 34,
  ...
  {
    id: 140,
    name: "Hyjnilerëve House",
    alternateName: "Shtëpia e Hyjnilerëve",
    type: "Historic House",
    region: "Kosovo",
    county: "Prishtina",
    lat: 42.6605,
    ...
    endYear: 2025,
    era: ["Ottoman"],
    description: "Historic 19th century family house in Prishtina. Showcases traditional architectural styles of the era.",
    highlights: ["19th Century House", "Family Heritage", "Traditional Architecture", "Urban History"],
    visitInfo: { hours: "By appointment", entry: "Free", duration: "30 minutes" },
    image: "/images/castle.jpg",
    rating: 3.5,
    reviews: 28,
  ...
  },
  {
    ...
    alternateName: "Xhamia e Jashar Pashës",
    type: "Religious",
    region: "Kosovo",
    county: "Prishtina",
    lat: 42.6625,
    ...
    endYear: 2025,
    era: ["Ottoman"],
    description: "19th century Ottoman mosque in Prishtina named after Jashar Pasha. An important religious and architectural monument.",
    highlights: ["Ottoman Mosque", "19th Century", "Islamic Architecture", "Historic Monument"],
    visitInfo: { hours: "Open for prayers", entry: "Free", duration: "30 minutes" },
    image: "/images/mosque.jpg",
    rating: 4.1,
    reviews: 112,
  ...
  {
    id: 142,
    name: "National Library Pjetër Bogdani",
    alternateName: "Biblioteka Kombëtare Pjetër Bogdani",
    type: "Cultural",
    region: "Kosovo",
    county: "Prishtina",
    lat: 42.6560,
    ...
    endYear: 2025,
    era: ["Modern"],
    description: "Kosovo's National Library, designed by Croatian architect Andrija Mutnjaković. Unique brutalist architecture with distinctive domed structure.",
    highlights: ["Brutalist Architecture", "National Library", "Iconic Design", "Cultural Institution"],
    visitInfo: { hours: "8:00 AM - 8:00 PM", entry: "Free", duration: "1 hour" },
    image: "/images/ruins.jpg",
    rating: 4.4,
    reviews: 789,
    verified: true
  },
  {
    ...
    alternateName: "Biblioteka Hivzi Sylejmani",
    type: "Cultural",
    region: "Kosovo",
    county: "Prishtina",
    lat: 42.6640,
    ...
    endYear: 2025,
    era: ["Modern"],
    description: "Historic public library founded in 1930, named after educator Hivzi Sylejmani. Important cultural institution in Prishtina.",
    highlights: ["Historic Library", "1930s Architecture", "Cultural Institution", "Educational Heritage"],
    visitInfo: { hours: "8:00 AM - 6:00 PM", entry: "Free", duration: "1 hour" },
    image: "/images/ruins.jpg",
    rating: 4.0,
    reviews: 145,
    verified: true
  ...
  {
    id: 144,
    name: "Former Hotel Jadran",
    alternateName: "Ish-Hoteli Jadran",
    type: "Historic Building",
    region: "Kosovo",
    county: "Mitrovicë",
    lat: 42.8900,
    ...
    endYear: 2025,
    era: ["Modern"],
    description: "Historic 20th century hotel building in Mitrovica. An example of mid-century urban architecture and hospitality heritage.",
    highlights: ["Mid-Century Architecture", "Urban Heritage", "Historic Hotel", "City Landmark"],
    visitInfo: { hours: "Exterior viewing", entry: "Free", duration: "15 minutes" },
    image: "/images/ruins.jpg",
    rating: 3.4,
    reviews: 45,
  ...
  // NEW KOSOVO SITES - Archaeological / Fortress
  {
    id: 145,
    name: "Qyteza Archaeological Site",
    alternateName: "Lokaliteti Arkeologjik Qyteza",
    type: "Archaeological",
    region: "Kosovo",
    county: "Klinë",
    lat: 42.6200,
    ...
    endYear: 400,
    era: ["Roman"],
    description: "Roman-era archaeological site near Klina. Contains remains of a Roman settlement with artifacts from the 1st-4th century AD.",
    highlights: ["Roman Settlement", "Archaeological Excavations", "Ancient Artifacts", "Historic Site"],
    visitInfo: { hours: "Daylight hours", entry: "Free", duration: "1 hour" },
    image: "/images/ruins.jpg",
    rating: 3.8,
    reviews: 67,
  ...
  {
    id: 146,
    name: "Keqekollë Fortress",
    alternateName: "Kalaja e Keqekollës",
    type: "Fortress",
    region: "Kosovo",
    county: "Prishtina",
    lat: 42.7000,
    ...
    endYear: 600,
    era: ["Roman", "Byzantine"],
    description: "Late Antique fortress near Prishtina dating from 4th-6th century. Strategic hilltop position with panoramic views.",
    highlights: ["Late Antique Fortress", "Hilltop Location", "Archaeological Site", "Panoramic Views"],
    visitInfo: { hours: "Daylight hours", entry: "Free", duration: "1.5 hours" },
    image: "/images/fortress.jpg",
    rating: 4.0,
    reviews: 89,
  ...
  {
    id: 147,
    name: "Vendenis Archaeological Site",
    alternateName: "Vindenis / Lokaliteti Vendenis",
    type: "Archaeological",
    region: "Kosovo",
    county: "Podujevë",
    lat: 42.9100,
    ...
    endYear: 600,
    era: ["Roman", "Byzantine"],
    description: "Roman and Late Antique city site. One of the most important archaeological localities in Kosovo with extensive Roman remains.",
    highlights: ["Roman City", "Late Antique Remains", "Major Archaeological Site", "Historic Settlement"],
    visitInfo: { hours: "Daylight hours", entry: "Free", duration: "2 hours" },
    image: "/images/ruins.jpg",
    rating: 4.2,
    reviews: 156,
  ...
  {
    id: 148,
    name: "Fusha e Madhe Archaeological Site",
    alternateName: "Fusha e Madhe dhe Tuma",
    type: "Archaeological",
    region: "Kosovo",
    county: "Suharekë",
    lat: 42.3500,
    ...
    startYear: -2000,
    endYear: -500,
    era: ["Prehistoric", "Illyrian"],
    description: "Important prehistoric and Illyrian tumuli site. Contains burial mounds and artifacts from the Bronze and Iron Ages.",
    highlights: ["Burial Mounds", "Prehistoric Artifacts", "Illyrian Heritage", "Archaeological Excavations"],
    visitInfo: { hours: "Daylight hours", entry: "Free", duration: "1.5 hours" },
    image: "/images/ruins.jpg",
    rating: 3.7,
    reviews: 45,
